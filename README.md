...
See [docs/status/health.md](docs/status/health.md) for current service health.
Run the [Health Check](https://github.com/Everythingcloudsolutions/FamilyShield/actions/workflows/scheduled-health-check.yml) workflow manually to refresh.
