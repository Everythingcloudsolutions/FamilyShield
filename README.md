...
**Last checked:** 2026-04-19 10:44:53 UTC
...
|---------|--------|----------------|
| Portal | ✅ HTTP 200 | 331ms |
| API | ✅ HTTP 200 | 143ms |
| AdGuard Home | ✅ HTTP 302 | 103ms |
| Headscale | ❌ HTTP 000000 | 55ms |
| mitmproxy | ⚠️ HTTP 403 | 140ms |
| Grafana | ✅ HTTP 302 | 100ms |
| Node-RED | ✅ HTTP 200 | 145ms |
| ntfy | ✅ HTTP 200 | 129ms |
| Redis | ✅ healthy | 1213ms |
| InfluxDB | ✅ healthy | 906ms |
...
| Service | Status | Response Time |
|---------|--------|----------------|
| Portal | ❌ HTTP 530 | 94ms |
| API | ❌ HTTP 530 | 94ms |
| AdGuard Home | ❌ HTTP 530 | 122ms |
| Headscale | ❌ HTTP 000000 | 68ms |
| mitmproxy | ❌ HTTP 530 | 107ms |
| Grafana | ❌ HTTP 530 | 96ms |
| Node-RED | ❌ HTTP 530 | 104ms |
| ntfy | ❌ HTTP 000000 | 30ms |
| Redis | ❌ unhealthy | 168ms |
| InfluxDB | ❌ unhealthy | 133ms |
